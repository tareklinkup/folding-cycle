                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <v-select v-bind:options="brand" label="brand_name" v-model="selectedBrand"
                                            ref="quantity"></v-select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <v-select v-bind:options="filterproducts" v-model="selectedProduct"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <v-select v-bind:options="lots" v-model="selectedLot"
                                            label="PurchaseMaster_LotNo" v-on:input="LotOnChange"></v-select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right"> Brand </label>
                                    <div class="col-xs-9">
                                        <v-select v-bind:options="brand" label="brand_name" v-model="selectedFreeBrand">
                                        </v-select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <v-select v-bind:options="filterFreeProducts" v-model="selectedFreeProduct"
                                            label="display_text" v-on:input="freeProductOnChange"></v-select>
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
                                        <a href="<?= base_url('product') ?>" class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;"
                                            target="_blank" title="Add"><i class="fa fa-plus" aria-hidden="true"
                                ...
                                <div class="form-group clearfix">
                                    <label class="col-xs-3 control-label no-padding-right"> Lot No</label>
                                    <div class="col-xs-5">
                                        <v-select v-bind:options="freeLots" v-model="selectedFreeLot"
                                            label="PurchaseMaster_LotNo" v-on:input="FreeLotOnChange"></v-select>
                                    </div>
                                    <label class="col-xs-1 control-label no-padding text-right"> Qty</label>
                                    <div class="col-xs-3">
                                        <input type="number" min="0" ref="freePQuantity" placeholder="Qty"
                                            class="form-control" v-model="selectedFreeProduct.free_quantity"
                                            autocomplete="off" />
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            <div style="display:none" v-bind:style="{display: isproductFreeStock ? '' : 'none'}">
                                <div
                                    style="margin-top:42px;background:#eee;text-align:center;font-size:14px;padding: 7px;">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-6">
                                                    <input type="button" class="btn btn-default btn-sm"
                                                        v-model="sales.updateName" v-on:click="saveSales"
    ...
    methods: {
        ...
        addToCart() {
            let product = {
                ...
                FreeProduct_Purchase_Rate: this.selectedFreeLot.PurchaseDetails_Rate ? this.selectedFreeLot
