...
<div class="row" id="purchase">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right text-right"> Lot No </label>
                <div class="col-sm-2">
                    <input type="text" id="invoice" name="invoice" v-model="purchase.lot_no" style="height:26px;"
                        v-bind:disabled="purchase.purchaseId != 0 " />
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-1 control-label no-padding text-right"> Purchase For </label>
                <div class="col-sm-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <label class="col-xs-6 control-label no-padding-right">Previous
                                                    Due</label>
                                                <div class="col-xs-6">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-6">
                                                    <input type="button" class="btn btn-success"
                                                        v-model="purchase.updateName" value="Purchase"
...
new Vue({
    ...
    methods: {
        ...
        savePurchase() {
            ...
            if (this.purchase.lot_no == '') {
                alert('Enter purchase Lot No');
                return;
            }
            ...
            let conf_sale = confirm("Do you want to " + this.purchase.updateName + "?");
            if (conf_sale) {
        ...
        async getPurchase() {
            await axios.post('/get_purchases', {
                ...
                this.purchase.lot_no = purchase.PurchaseMaster_LotNo;
                this.purchase.updateName = 'Update';
